...
@Component({
  ...
  template: `
    <svg aria-hidden="true" class="hidden">
      ...
      <symbol id="i-despliegue" viewBox="0 0 24 24">
        <path
          d="M12 3c3 2.2 4.5 5.2 4.5 8.5L14 15h-4l-2.5-3.5C7.5 8.2 9 5.2 12 3z" />
      ...
      <symbol id="i-enviar" viewBox="0 0 24 24">
      ...
      <symbol id="i-rama" viewBox="0 0 24 24">
        ...
        <path d="M7 8v8" />
        <path d="M17 11v.5a4 4 0 0 1-4 4H9.4" />
      </symbol>
    </svg>
  `,
  styles: `
